...
public class Test
{
    ...
    public void outputResult () throws IOException {
        ...
        File file = new File("C:\\Users\\Hp\\Desktop\\BT\\src\\files\\output");
        if (!file.exists()) {
            file.createNewFile();
        }
    ...
    public void readEdIndex (Bug testBug) throws IOException, ParseException {
        String indexPath = "C:\\Users\\Hp\\Desktop\\BT\\src\\files\\edIndex";
    ...
    private void readNedIndex (Bug testBug) throws IOException, ParseException {
        String indexPath = "C:\\Users\\Hp\\Desktop\\BT\\src\\files\\nedIndex";
    ...
    private void readFgIndex (Bug testBug) throws IOException, ParseException {
        String indexPath = "C:\\Users\\Hp\\Desktop\\BT\\src\\files\\fgIndex";
